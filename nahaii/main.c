...
#include <math.h>
#include "myheder.h"
// gcc main.c functions.c -lm ~/projects/test2/bmpio/lib/libfcp.a -o main $(pkg-config allegro-5 allegro_font-5 allegro_primitives-5 allegro_audio-5 allegro_acodec-5 allegro_dialog-5 --libs --cflags)
...
void drawsaat(int s, int m, int h)
{
    ...
    al_clear_to_color(al_map_rgb(50, 50, 50));
    al_draw_textf(font, al_map_rgb(255, 255, 255), 680 / 2, 680, ALLEGRO_ALIGN_CENTER, "%02d:%02d:%02d", h, m, s);
...
for a ellips in polar coorditnate:
